...
namespace MultiPingMonitor.UI
{
    public partial class OptionsWindow : Window
    {
        ...
        private void PopulateDisplayOptions()
        {
            ...
            IsDarkModeEnabled.IsChecked = ApplicationOptions.Theme == ApplicationOptions.AppTheme.Dark;
        }
        ...
        private bool SaveDisplayOptions()
        {
            ...
            var newTheme = IsDarkModeEnabled.IsChecked == true
                ? ApplicationOptions.AppTheme.Dark
                : ApplicationOptions.AppTheme.Light;
            if (newTheme != ApplicationOptions.Theme)
            {
